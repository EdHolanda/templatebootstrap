...
<html lang="en">
    <head>
        ...
        <title>Home - SB Admin Pro</title>
        <link href="https://themes.startbootstrap.com/sb-ui-kit-pro/css/styles.css" rel="stylesheet" />
                ...
                <main>
                        ...
                        <div class="container">
                            ...
                            <div class="row text-center">
                                <div class="col-lg-4 mb-5">
                                    ...
                                    <a class="d-block rounded-lg lift lift-lg" href="landing-multipurpose.html"><img class="img-fluid rounded-lg" src="assets/img/screenshots/landing-multipurpose.jpg"/></a>
                                </div>
                                <div class="col-lg-4 mb-5">
                                    <h6 class="mb-3">Demo 2 - Mobile App</h6>
                                    <a class="d-block rounded-lg lift lift-lg" href="landing-app-mobile.html"><img class="img-fluid rounded-lg" src="assets/img/screenshots/landing-app-mobile.jpg"/></a>
                                </div>
                                <div class="col-lg-4 mb-5">
                                    <h6 class="mb-3">Demo 3 - Desktop App</h6>
                                    <a class="d-block rounded-lg lift lift-lg" href="landing-app-desktop.html"><img class="img-fluid rounded-lg" src="assets/img/screenshots/landing-app-desktop.jpg"/></a>
                                </div>
                                <div class="col-lg-4 mb-5">
                                    <h6 class="mb-3">Demo 4 - Agency</h6>
                                    <a class="d-block rounded-lg lift lift-lg" href="landing-agency.html"><img class="img-fluid rounded-lg" src="assets/img/screenshots/landing-agency.jpg"/></a>
                                </div>
                                <div class="col-lg-4 mb-5">
                                    <h6 class="mb-3">Demo 5 - Lead Capture</h6>
                                    <a class="d-block rounded-lg lift lift-lg" href="landing-lead-capture.html"><img class="img-fluid rounded-lg" src="assets/img/screenshots/landing-lead-capture.jpg"/></a>
                                </div>
                                <div class="col-lg-4 mb-5">
                                    <h6 class="mb-3">Demo 6 - Press</h6>
                                    <a class="d-block rounded-lg lift lift-lg" href="landing-press.html"><img class="img-fluid rounded-lg" src="assets/img/screenshots/landing-press.jpg"/></a>
                                </div>
                                <div class="col-lg-4 mb-5">
                                    <h6 class="mb-3">Demo 7 - Directory</h6>
                                    <a class="d-block rounded-lg lift lift-lg" href="landing-directory.html"><img class="img-fluid rounded-lg" src="assets/img/screenshots/landing-directory.jpg"/></a>
                                </div>
                                <div class="col-lg-4 mb-5">
                                    <h6 class="mb-3">Demo 8 - Rental</h6>
                                    <a class="d-block rounded-lg lift lift-lg" href="landing-rental.html"><img class="img-fluid rounded-lg" src="assets/img/screenshots/landing-rental.jpg"/></a>
                                </div>
                                <div class="col-lg-4 mb-5">
                                    <h6 class="mb-3">Demo 9 - Real Estate</h6>
                                    <a class="d-block rounded-lg lift lift-lg" href="landing-real-estate.html"><img class="img-fluid rounded-lg" src="assets/img/screenshots/landing-real-estate.jpg"/></a>
                                </div>
                                <div class="col-lg-4 mb-5">
                                    <h6 class="mb-3">Demo 10 - Classifieds</h6>
                                    <a class="d-block rounded-lg lift lift-lg" href="landing-classifieds.html"><img class="img-fluid rounded-lg" src="assets/img/screenshots/landing-classifieds.jpg"/></a>
                                </div>
                                <div class="col-lg-4 mb-5">
                                    <h6 class="mb-3">Demo 11 - Resume</h6>
                                    <a class="d-block rounded-lg lift lift-lg" href="landing-resume.html"><img class="img-fluid rounded-lg" src="assets/img/screenshots/landing-resume.jpg"/></a>
                                </div>
                                <div class="col-lg-4 mb-5">
                                    <h6 class="mb-3">Demo 12 - Portfolio</h6>
                                    <a class="d-block rounded-lg lift lift-lg" href="landing-portfolio.html"><img class="img-fluid rounded-lg" src="assets/img/screenshots/landing-portfolio.jpg"/></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            ...
                            <div class="row text-center">
                                <div class="col-lg-4 mb-5">
                                    ...
                                    <a class="d-block rounded-lg lift lift-lg" href="header-basic.html"><img class="img-fluid rounded-lg" src="assets/img/screenshots/header-basic.jpg"/></a>
                                </div>
                                <div class="col-lg-4 mb-5">
                                    <h6 class="mb-3">Demo 2 - Basic (Signup)</h6>
                                    <a class="d-block rounded-lg lift lift-lg" href="header-basic-signup.html"><img class="img-fluid rounded-lg" src="assets/img/screenshots/header-basic-signup.jpg"/></a>
                                </div>
                                <div class="col-lg-4 mb-5">
                                    <h6 class="mb-3">Demo 3 - Graphic</h6>
                                    <a class="d-block rounded-lg lift lift-lg" href="header-graphic.html"><img class="img-fluid rounded-lg" src="assets/img/screenshots/header-graphic.jpg"/></a>
                                </div>
                                <div class="col-lg-4 mb-5">
                                    <h6 class="mb-3">Demo 4 - Graphic (Signup)</h6>
                                    <a class="d-block rounded-lg lift lift-lg" href="header-graphic-signup.html"><img class="img-fluid rounded-lg" src="assets/img/screenshots/header-graphic-signup.jpg"/></a>
                                </div>
                                <div class="col-lg-4 mb-5">
                                    <h6 class="mb-3">Demo 5 - Inner Page</h6>
                                    <a class="d-block rounded-lg lift lift-lg" href="header-inner-page.html"><img class="img-fluid rounded-lg" src="assets/img/screenshots/header-inner-page.jpg"/></a>
                                </div>
                                <div class="col-lg-4 mb-5">
                                    <h6 class="mb-3">Demo 6 - Nav Only</h6>
                                    <a class="d-block rounded-lg lift lift-lg" href="header-nav-only.html"><img class="img-fluid rounded-lg" src="assets/img/screenshots/header-nav-only.jpg"/></a>
                                </div>
                            </div>
                        </div>
                        <div class="svg-border-rounded text-light">
                    ...
                    <section class="bg-light py-10">
                        <div class="container">
                            ...
                            <div class="text-center"><a class="btn btn-marketing btn-primary rounded-pill lift lift-sm" href="https://docs.startbootstrap.com/sb-ui-kit-pro/quickstart">View Documentation</a></div>
                        </div>
                        <div class="svg-border-rounded text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 144.54 17.34" preserveAspectRatio="none" fill="currentColor"><path d="M144.54,17.34H0V0H144.54ZM0,0S32.36,17.34,72.27,17.34,144.54,0,144.54,0" /></svg>
                        </div>
